...
A Data Engineering portfolio project that ingests ETF market data, loads it into Databricks, and transforms it through Bronze, Silver, and Gold layers using dbt.
...
This project is for Data Engineering portfolio and educational purposes only. It is not financial advice.
